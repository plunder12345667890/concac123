...
shared.LoaderTitle = "??ng Ký Kênh TBoy Roblox";
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=132176961571280";
v24.Parent = v23;
...
local v56 = v16.Main:AddSection("Thông Th?o");
local v57 = v16.Main:AddDropdown("DropdownMastery", {
    Title = "Cày Thông Th?o",
    Description = "",
    Values = {
        "Near Mobs"
    },
    ...
    spawn(function()
        pcall(function()
            while wait() do
                ...
                v485:SetDesc("Mày Có: " .. tostring(v768) .. " X??ng");
            end
        end);
    end);
...
if Sea3 then
    local v490 = v16.Main:AddSection("T? L?nh Bánh");
    local v491 = v16.Main:AddParagraph({
        Title = "Tr?ng Thái Nó Ra",
        Content = ""
    });
    spawn(function()
        while wait() do
            pcall(function()
                ...
                elseif (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86) then
                    ...
                    v491:SetDesc("T? L?nh Bánh : ??");
                end
            end);
        end
    end);
    local v492 = v16.Main:AddToggle("ToggleCake", {
        Title = "Cày T? L?nh Bánh",
        Description = "",
        Default = false
    });
    local v493 = true;
...
local v63 = v16.Main:AddSection("Nguyên Li?u");
if Sea1 then
    MaterialList = {
        "Scrap Metal",
        "Leather",
...
if Sea3 then
    local v498 = v16.Sea:AddSection("??o Cáo");
    local v499 = v16.Sea:AddParagraph({
        Title = "Tr?ng Thái ??o Cáo",
        Content = ""
    });
...
if Sea3 then
    local v503 = v16.Sea:AddSection("Bi?n");
    ...
    local v515 = v16.Sea:AddToggle("AutoFindFrozen", {
        Title = "Tìm ??o Leviathan",
        Description = "C?n 5 Ng??i Không Idk",
        Default = false
    });
    ...
    v16.Sea:AddButton({
        Title = "Bay ??n Thuy?n",
        Description = "Duy Nh?t Thuy?n B?n Mua ? Ch? Ch?n",
        Callback = function()
            v521();
        end
    });
...
if Sea3 then
    local v531 = v16.Sea:AddSection("??o Bí ?n");
    ...
    spawn(function()
        pcall(function()
            while wait() do
                v532:SetDesc("??o Bí ?n: " .. MirageStatus .. " | Tr?ng Tròn: " .. FullMoonStatus);
            end
        end);
    end);
    v16.Sea:AddButton({
...
local v66 = v16.Sea:AddToggle("ToggleTpAdvanced", {
    Title = "Bay ??n Advanced Fruit Dealer",
    Description = "",
    Default = false
});
...
local v93 = v16.Setting:AddSection("K? N?ng Thông Th?o");
...
local function v103()
    ...
    local v300 = v297 % 60 ;
    v102:SetDesc(string.format("%02d Ti?ng-%02d Phút-%02d Giây", v298, v299, v300));
end
spawn(function()
    while task.wait() do
        pcall(v103);
...
local v118 = v16.Teleport:AddSection("Th? Gi?i");
local v119 = v16.Teleport:AddToggle("ToggleAutoSea2", {
    Title = "Nhi?m V? Qua Bi?n 2",
    Description = "",
    Default = false
});
...
local v56 = v16.Teleport:AddSection("??o");
if Sea1 then
    IslandList = {
        "WindMill",
        "Marine",
...
local v56 = v16.Fruit:AddSection("??nh V?");
...
local v56 = v16.Raid:AddSection("T?p Kích Law");
local v143 = v16.Raid:AddToggle("ToggleLaw", {
    Title = "Mua Chip Và ??m Law",
    Description = "",
    Default = false
});
...
local v56 = v16.Race:AddSection("T?c");
v16.Race:AddButton({
    Title = "C?a T?c",
    Description = "",
    Callback = function()
...
local v144 = v16.Race:AddToggle("ToggleHumanandghoul", {
    Title = "Hoàn Thành ?i [Human/Ghoul]",
    Description = "",
    Default = false
});
...
local v56 = v16.Shop:AddSection("Kh? N?ng");
v16.Shop:AddButton({
    Title = "Nh?y",
    Description = "",
    Callback = function()
...
local v56 = v16.Shop:AddSection("Ki?m");
v16.Shop:AddButton({
    Title = "Cutlass",
    Description = "",
    Callback = function()
...
local v56 = v16.Misc:AddSection("??i");
v16.Misc:AddButton({
    Title = "H?i T?c",
    Description = "",
    Callback = function()
...
local v56 = v16.Misc:AddSection("Kinh Nghi?m");
local v150 = {
    "KITT_RESET",
    "Sub2UncleKizaru",
...
local v56 = v16.Misc:AddSection("Danh Hi?u");
v16.Misc:AddButton({
    Title = "Danh Hi?u",
    Description = "",
    Callback = function()
...
local v56 = v16.Misc:AddSection("Th?c T?nh");
v16.Misc:AddButton({
    Title = "Th?c T?nh",
    Description = "",
    Callback = function()
...
local v56 = v16.Misc:AddSection("S??ng");
local function v152()
...
if Sea3 then
    local v561 = v16.Sea:AddParagraph({
        Title = "Tr?ng Thái Chip Leviathan",
        Content = ""
    });
    spawn(function()
        pcall(function()
...
local v158 = v16.Sea:AddToggle("ToggleReceiveQuest", {
    ...
    Description = "B?t Lên 1 L?n Là Nh?n 1 Nh?n N?a Thì T?t B?t L?i",
    Default = false
});
...
v156:AddButton({
    Title = "Bay ??n Khu V?c Dragon Dojo",
    Description = "",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(5661.5322265625, 1013.0907592773438, - 334.9649963378906));
        Tween2(CFrame.new(5814.42724609375, 1208.3267822265625, 884.5785522460938));
...
local v166 = v16.Sea:AddParagraph({
    Title = "Hoàn Thành ?i Draco V4 (S?m Ra)",
    Content = ""
});
local v167 = v16.Sea:AddToggle("ToggleTrialTeleport", {
    Title = "Bay ??n C?a Trial T?c Draco",
    Description = "",
    Default = false
});
